...
반드시 '오직 JSON만'(name은 반드시 구체적 수치로): {"reply":"...","goals":[{"name":"유료 구독자 300명","targetDate":"2026-02-28","rationale":"구독가 1만원 가정 시 월 매출 300만원 규모, 초기 목표로 현실적","successCriteria":[{"type":"metric","name":"유료 구독자","target":300,"current":0,"unit":"명","measurementPeriod":"월"},{"type":"metric","name":"월 매출","target":300,"current":0,"unit":"만원","measurementPeriod":"월"}]}]}
