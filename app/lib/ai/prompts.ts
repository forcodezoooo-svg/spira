...
%%%ROUTINE_ADD%%%
[{"wsId":"..","programId":"..","deadlineId":"..","todoId":"..","tasks":[{"name":"일시적 할일","date":"2026-09-05"},{"name":"반복 할일","days":[1],"startDate":"2026-09-01"}]}]

규칙:
- 마커 다음 줄에 JSON 배열만(다른 텍스트 금지). 각 원소는 '한 카테고리'이며 wsId/programId/deadlineId/todoId는 반드시 위 목록의 값을 그대로 사용.
...
⚠️ 매우 중요: 업무를 추가/배치하는 설계안을 제시했다면 **답변을 마커 없이 끝내지 마세요.** 마커가 없으면 '프로세스에 추가' 버튼이 뜨지 않아 사용자가 반영할 수 없습니다. "추가해볼까요?"라고 묻기만 하고 마커를 빼먹는 실수를 절대 하지 마세요 — 설계안과 함께 반드시 마커를 붙이세요.
