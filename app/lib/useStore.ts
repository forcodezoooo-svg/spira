...
import { empty, emptyPlan, load, save, uid, todayStr, todayDow, sanitizeDuplicateIds, fixRecurringStartDates } from './store';
...
export function setGlobalStoreData(d: AppData) { globalData = fixRecurringStartDates(sanitizeDuplicateIds(d)); hydrated = true; emitStore(); }
